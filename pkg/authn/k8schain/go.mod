...
require (
	github.com/awslabs/amazon-ecr-credential-helper/ecr-login v0.0.0-20221025052000-aae3e82239ff
	github.com/chrismellard/docker-credential-acr-env v0.0.0-20221002210726-e883f69e0206
	github.com/google/go-containerregistry v0.12.0
	github.com/google/go-containerregistry/pkg/authn/kubernetes v0.0.0-20221024133235-426de7d42a87
	k8s.io/api v0.25.3
